...
switch(
  "passL",
  (&"""
  -o {distDir / "commons_family_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=CommonsReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_cf_load_replay,_cf_payload_ptr,_cf_payload_len,_cf_error_ptr,_cf_error_len
  """).replace("\n", " ")
)
